...
<section class="wrapperRechercheAvancee">
    <a href="/albums"><button>Reset</button></a>

    <form action="/albums" method="get" class="formArtiste">
        <div>
    ...
    <form action="/albums" method="get" class="formGenre">
        <div>
    ...
    <form action="/albums" method="get" class="formAnnee">
        <div>
...
<section class="wrapperSectionAlbum">
